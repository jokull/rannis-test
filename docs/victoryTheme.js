...
const purple = "#4D003A";
const rose = "#9A0074";
const roseLight = "#D799C7";
const rosePale = "#EBCCE3";
const mint = "#00E4CA";
const mintLight = "#99F4EA";
const colors = [rose, purple, roseLight, rosePale, mint, mintLight];
const blueGrey50 = "#ECEFF1";
const blueGrey300 = "#90A4AE";
const blueGrey700 = "#455A64";
const grey900 = "#212121"; // Typography

const sansSerif = "'IBM Plex Sans', sans-serif";
const letterSpacing = "normal";
const fontSize = 12; // Layout
